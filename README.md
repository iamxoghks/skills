...
> 이 저장소는 이전 독립 배포 이력을 보존하는 읽기 전용 저장소입니다.
> 최신 스킬은 [`iamxoghks/skills`](https://github.com/iamxoghks/skills/tree/main/skills/storyboard-builder)에서 관리합니다.

[![skills.sh 설치 수](https://skills.sh/b/iamxoghks/skills/storyboard-builder)](https://skills.sh/iamxoghks/skills/storyboard-builder)
...
설치 후 Codex를 다시 시작하면 `$storyboard-builder`를 사용할 수 있습니다.

### skills.sh CLI로 설치

공개 Agent Skills CLI를 사용해 Codex 전역 스킬로 설치할 수도 있습니다.
...
[skills.sh의 Storyboard Builder 페이지](https://skills.sh/iamxoghks/skills/storyboard-builder)에서
설치 정보와 공개 설치 수를 확인할 수 있습니다.
