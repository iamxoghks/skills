...
[![skills.sh 설치 수](https://skills.sh/b/iamxoghks/storyboard-builder)](https://skills.sh/iamxoghks/storyboard-builder/storyboard-builder)
...
[skills.sh의 Storyboard Builder 페이지](https://skills.sh/iamxoghks/storyboard-builder/storyboard-builder)에서
설치 정보와 공개 설치 수를 확인할 수 있습니다.

### 저장소에서 직접 설치

이 저장소를 내려받은 뒤 다음 명령을 실행합니다.
